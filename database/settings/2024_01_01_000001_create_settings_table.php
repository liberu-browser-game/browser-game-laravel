...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('general.site_name', config('app.name', 'Liberu Browser Game'));
        ...
        $this->migrator->add('general.github_url', 'https://www.github.com/liberu-browser-game/browser-game-laravel');
        $this->migrator->add('general.youtube_url', null);
        $this->migrator->add('general.footer_copyright', '© ' . date('Y') . ' ' . config('app.name', 'Liberu Browser Game') . '. All rights reserved.');
    }
};